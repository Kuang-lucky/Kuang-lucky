<?php
		...
		if ($conn->connect_error){
	     ...
	     $page;//当前页
	  	...
	  	//构建查询语句获取总记录数和计算总页数
		  $sql="select * from php_user order by userid desc";
		  ...
		  $sql="select * from php_user order by userid asc limit {$start_row},{$pagesize}";
		  $result=$conn->query($sql);
				...
				<?php
					...
					{	echo "<tr>";
						...
						echo "<td>".$row['E_mail']."</td>"; 
					 	$id=$row['userid'];
						echo "<td><button><a href=update.php?userid=$id style=color:#28b76b>修改</a></button></td>";
					 	echo "<td><button><a href=delete.php?userid=$id style=color:#28b76b>删除</a></button></td>";
					 	echo "<tr>";
